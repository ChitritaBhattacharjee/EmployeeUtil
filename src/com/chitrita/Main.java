...
//		System.out.println(salesman.computeSal());
		...
		try {
			do {
				...
				switch(ch) {
					case 1: System.out.print("Enter regno: ");
						...
						eAl.add(new Manager(regno, ename, basic, carAllowance, ma));
						break;
					case 2: Clerk c = new Clerk();
						System.out.print("Enter the regno: ");
						c.setRegno(Long.parseLong(sc.nextLine()));
						System.out.print("Enter employee name: ");
					...
					case 3: Salesman s = new Salesman();
						System.out.print("Enter the regno: ");
						s.setRegno(Long.parseLong(sc.nextLine()));
						System.out.print("Enter employee name: ");
		...
		catch (NumberFormatException | EmployeeRegnoException e) {
			System.out.println("Exception occured. "+e.getMessage());
//			System.out.print("Enter some non-zero number to continue / 0 to exit: ");
//			ch = Integer.parseInt(sc.nextLine());
		} 
		finally {
			sc.close();
		...
		System.out.println("End of employee application.");
	}
}
